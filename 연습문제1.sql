...
*/
INSERT INTO tbl_book (book_id, book_name, book_publisher, book_price)
VALUES
(1, '축구의 역사', '굿스포츠', 7000),
(2, '축구 아는 여자','나이스북', 13000),
(3, '축구의 이해','대한미디어', 22000),
...
*/
SELECT order_id, cust_name, book_name, b.book_price * amount, ordered_at
FROM tbl_order o
JOIN tbl_customer c
